...
import '../../modules/timer_sheets/data/repository.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i7.TimeSheetRepository>(
        () => _i8.TimeSheetRepositoryImp(gh<_i5.OdooApi>()));
    gh.factory<_i9.GetTimeSheetUsecase>(
        () => _i9.GetTimeSheetUsecaseImp(gh<_i7.TimeSheetRepository>()));
    gh.lazySingleton<_i10.TimesheetBloc>(
        () => _i10.TimesheetBloc(gh<_i9.GetTimeSheetUsecase>()));
    return this;
  }
}

class _$InjectableModules extends _i11.InjectableModules {
